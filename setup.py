...
setup(name='pymysqlrpc',
      ...
      long_description="""\
pymysqlrpc is a very interesting, very simple RPC framework, implement mysql server protocol,  on top of gevent,
map one call of mysql stored procedures to python's a function or a method of an instance.""",
      classifiers=[],
